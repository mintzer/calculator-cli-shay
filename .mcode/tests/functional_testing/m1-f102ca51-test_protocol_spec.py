...
Generated at: 2026-03-03T16:53:13.548377+00:00
...
TEST_CASES = resolve_env_placeholders(json.loads(r'''[
    ...
    {
        "name": "test_div_even_division",
        "category": "HAPPY_PATH",
        "description": "Divide evenly with no remainder",
        "command": "calc",
        "subcommand": "",
        "args": [
            "div",
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Multiply by zero gives zero",
        "command": "calc",
        "subcommand": "",
        "args": [
            "mul",
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Subtract identical numbers gives zero",
        "command": "calc",
        "subcommand": "",
        "args": [
            "sub",
    ...
    },
    {
        "name": "test_div_one",
        "category": "HAPPY_PATH",
        "description": "Divide by one returns the dividend",
        "command": "calc",
        "subcommand": "",
        "args": [
            "div",
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Multiply two negative numbers gives positive",
        "command": "calc",
        "subcommand": "",
        "args": [
            "mul",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Zero divided by zero is also a division by zero error",
        "command": "calc",
        "subcommand": "",
        "args": [
            "div",
    ...
    },
    {
        ...
        "description": "No arguments provided should print usage and exit non-zero",
        "command": "calc",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "INVALID_ARGS",
        "description": "Only operation provided, missing both operands",
        "command": "calc",
        "subcommand": "",
        "args": [
            "add"
    ...
    },
    {
        ...
        "category": "INVALID_ARGS",
        "description": "Missing second operand",
        "command": "calc",
        "subcommand": "",
        "args": [
            "add",
    ...
    },
    {
        ...
        "category": "INVALID_ARGS",
        "description": "Invalid operation name should fail",
        "command": "calc",
        "subcommand": "",
        "args": [
            "foo",
    ...
    },
    {
        ...
        "description": "Unknown flag should fail",
        "command": "calc",
        "subcommand": "",
        "args": [
            "--unknown",
    ...
    {
        "name": "test_verbose_flag_not_supported",
        "category": "INVALID_OPTIONS",
        "description": "Unsupported --verbose flag should fail",
        "command": "calc",
        "subcommand": "",
        "args": [
            "--verbose",
